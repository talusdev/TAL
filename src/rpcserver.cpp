...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TAL features */
        {"tal", "masternode", &masternode, true, true, false},
        {"tal", "masternodelist", &masternodelist, true, true, false},
        {"tal", "mnbudget", &mnbudget, true, true, false},
        {"tal", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"tal", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tal", "mnsync", &mnsync, true, true, false},
        {"tal", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tald, or the -server option to tal-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tal-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18512/\n";
}
