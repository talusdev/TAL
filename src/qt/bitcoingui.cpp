                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TAL-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TAL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tal: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TALUS"), this);
    aboutAction->setStatusTip(tr("Show information about TALUS"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TAL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TAL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TAL addresses"));
    ...
    openAction->setStatusTip(tr("Open a TAL: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TALUS help message to get a list with possible TAL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TALUS client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TAL network", "", count));
}
...
{
    QString strTitle = tr("TALUS"); // default title
