...
RESOURCES += src/qt/tal.qrc src/qt/tal_locale.qrc

TRANSLATIONS += src/qt/locale/tal_bg.ts \
                src/qt/locale/tal_de.ts \
                src/qt/locale/tal_en.ts \
                src/qt/locale/tal_es.ts \
                src/qt/locale/tal_fi.ts \
                src/qt/locale/tal_fr.ts \
                src/qt/locale/tal_it.ts \
                src/qt/locale/tal_ja.ts \
                src/qt/locale/tal_pl.ts \
                src/qt/locale/tal_pt.ts \
                src/qt/locale/tal_ru.ts \
                src/qt/locale/tal_sk.ts \
                src/qt/locale/tal_sv.ts \
                src/qt/locale/tal_vi.ts \
                src/qt/locale/tal_zh_CN.ts \
                src/qt/locale/tal_zh_TW.ts
