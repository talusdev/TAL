...
In order to support loading of multiple wallets in tal-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tal.cpp.
...
Changes to tal.cpp
----------------------
tal.cpp is the entry point into tal-qt, and as such, will require some minor modifications to provide hooks for
